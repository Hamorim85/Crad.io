...
class RequestService
  def initialize(node, user_hash, options = {})
    ...
    # @node.igid = '22248701561'
    # @user_hash = '37479f2b8209594dde7facb0d904896a'
    @curl = "https://www.instagram.com/graphql/query/?query_hash=#{@user_hash}&variables=%7B%22id%22%3A%#{@node.igid}%22%2C%22first%22%3A20%7D"
  ...
  def keep_going
    ...
    loop do
      ...
      @curl = "https://www.instagram.com/graphql/query/?query_hash=#{@user_hash}&variables=%7B%22id%22%3A%#{@node.igid}%22%2C%22first%22%3A10%2C%22after%22%3A%22#{@next_page_key}%22%7D"
      p doc['edges']
      @followers += doc['edges']
